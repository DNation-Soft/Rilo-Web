        ...
        <section class="container py-100">
            <div class="row g-20">
                <div class="col-md-3 col-sm-6 sidebar ">
                    <div class="mb-4">
                        ...
                        <ul class="service-list">
                            ...
                            <li><a href="{{route('service.details','')}}">Graphic Design</a></li>
                            <li><a href="/ui-ux-design">UI/UX Design</a></li>
                            <li><a class="active" href="/digital-marketing"><span class="arrow-right"><svg
                                            width="9" height="15" viewBox="0 0 9 15" fill="none"
                ...
                <div class="col-md-9 col-sm-6">
                    <div class="content">
                        <h2 class="title-1 gradient-common mb-4">Grow Your Business with Smart Marketing</h2>
                        <p class="mb-4">We help businesses grow by connecting them with the right audience through
                            data-driven digital marketing strategies. Our approach focuses on increasing visibility,
                            generating quality leads, and turning them into loyal customers.</p>
                        <p class="mb-4">From social media marketing to search engine campaigns, we create targeted
                            strategies based on your business goals and market behavior. We continuously monitor
                            performance, analyze data, and optimize campaigns to ensure the best possible results.</p>
                        <p class="mb-5">Our goal is simple: to help you achieve consistent growth and maximize your
                        ...
                        <div class="d-flex gap-3 align-items-center mb-5 flex-wrap">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <span>Better ROI on marketing spend</span>
                            </div>
                        </div>
                        ...
                        <div class="accordion mb-5" id="faqAccordion">
                            ...
                            <div class="accordion-item flipup-hover mb-3">
                                ...
                                <div id="collapse1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        We work with Facebook, Google, Instagram, and more.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item flipup-hover mb-3">
                                ...
                                <div id="collapse2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Some results can be seen within weeks, but long-term growth takes consistent
                                        effort.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item flipup-hover mb-3">
                                ...
                                <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we provide regular performance reports and insights.
                                    </div>
                                </div>
                            </div>
                        </div>
