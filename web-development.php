        ...
        <section class="container py-100">
            <div class="row g-20">
                <div class="col-md-3 col-sm-6 sidebar ">
                    <div class="mb-4">
                        ...
                        <ul class="service-list">
                            <li class="">
                                <a class="active" href="/web-development"><span class="arrow-right"><svg width="9"
                ...
                <div class="col-md-9 col-sm-6">
                    <div class="content">
                        <h2 class="title-1 gradient-common mb-4">Build Fast, Scalable & High-Performing Websites

                        </h2>
                        <p class="mb-4">We build modern, responsive, and high-performance websites that are tailored to
                            your business goals. Our focus is not just on design, but on creating a complete digital
                            experience that delivers speed, security, and scalability.</p>
                        <p class="mb-4">From simple business websites to complex web applications, we ensure every
                            project is optimized for performance and user experience. Our development approach combines
                            clean code, strong architecture, and SEO-friendly structure—so your website not only looks
                            great but also performs exceptionally well in the long run.</p>
                        <p class="mb-5">We create solutions that grow with your business and support your future
                            expansion.</p>

                        <img class="img-fluid" src="assets/image/services/webdevelopment.jpeg" alt="services">
                        ...
                        <div class="d-flex gap-3 align-items-center mb-5 flex-wrap">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <span>Custom-built to match your business goals</span>
                            </div>
                            <div class="d-flex gap-2 align-items-center">
                                <svg width="22" height="21" viewBox="0 0 22 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="accordion mb-5" id="faqAccordion">
                            ...
                            <div class="accordion-item flipup-hover mb-3">
                                ...
                                <div id="collapse1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        It depends on the complexity, but most projects take 1–4 weeks.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item flipup-hover mb-3">
                                ...
                                <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we can build user-friendly systems so you can easily manage your content.
                                    </div>
                                </div>
                            </div>
                        </div>
