...
<head>
    ...
    <title>Portfolio Details | Rilo </title>
    ...
    <style>
        /* Critical CSS for https://rilo-denation.netlify.app/portfolio-details */
        @charset "UTF-8";
    ...
    <link rel="preload" href="assets/css/portfolio-details.css" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
...
<body>
    <header>
        ...
        <div class="d-flex w-100 justify-content-center align-items-center position-relative">
            <h3 class="text-center text-white brudcumb-title title-3 animate-title position-absolute">Portfolio Details
            </h3>
        </div>
    </header>
        ...
        <section class="container py-100">
            <div class="row g-20">
                <div class="col-md-3 col-sm-6 sidebar ">
                    <div class="mb-4">
                        <h2 class="section-title-common mb-4">Portfolio </h2>
                        <ul class="service-list">
                            <li class="">
                                <a class="active" href=""><span class="arrow-right"><svg width="9" height="15"
                ...
                <div class="col-md-9 col-sm-6">
                    <div class="content">
                        <h2 class="title-1 gradient-common mb-4">Food app design
                        </h2>
                        <p class="mb-4">Our services are designed to elevate your brand and enhance user experience.
                        ...
                        <img class="img-fluid" src="assets/image/services/1.webp" alt="">
                        ...
                        <h2 class="title-4 mb-4">Live link</h2>
                        <div class="mb-5">
                            <a href="mailto:dnationsoft.com" target="_blank" class="live-link">dnationsoft.com</a>
                        </div>
