        ...
        <section class="container py-100">
            <div class="row g-20">
                <div class="col-md-3 col-sm-6 sidebar ">
                    <div class="mb-4">
                        ...
                        <ul class="service-list">
                            ...
                            <li><a class="active" href="/ui-ux-design"><span class="arrow-right"><svg width="9"
                ...
                <div class="col-md-9 col-sm-6">
                    <div class="content">
                        <h2 class="title-1 gradient-common mb-4">Design Experiences That Users Love
                        </h2>
                        <p class="mb-4">We design intuitive, user-focused interfaces that make your digital products
                            easy to use and visually appealing. Our goal is to create seamless user experiences that
                            guide users naturally and keep them engaged.</p>
                        <p class="mb-5">We start by understanding your users, their behavior, and your business
                            objectives. Then we craft designs that are clean, modern, and aligned with your brand
                            identity. From wireframes to interactive prototypes, every step is focused on usability and
                            performance.</p>
                        <p class="mb-4">A well-designed UI/UX not only improves user satisfaction but also increases
                            conversions and builds trust in your product.
                        </p>
                        ...
                        <div class="d-flex gap-3 align-items-center mb-5 flex-wrap">
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <span>User-centered and intuitive design</span>
                            </div>
                            <div class="d-flex gap-2 align-items-center">
                                <svg width="22" height="21" viewBox="0 0 22 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span>Clean and modern visual interface</span>
                            </div>
                            <div class="d-flex gap-2 align-items-center">
                                <svg width="22" height="21" viewBox="0 0 22 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span>Improved user engagement</span>
                            </div>
                            <div class="d-flex gap-2 align-items-center">
                                <svg width="22" height="21" viewBox="0 0 22 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="accordion mb-5" id="faqAccordion">
                            ...
                            <div class="accordion-item flipup-hover mb-3">
                                ...
                                <div id="collapse1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        UI focuses on visual design, while UX ensures a smooth and enjoyable user
                                        experience.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item flipup-hover mb-3">
                                ...
                                <div id="collapse2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we can improve and redesign your current UI/UX for better performance.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item flipup-hover mb-3">
                                <h2 class="accordion-header" id="heading3">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Will I get design prototypes?
                                    </button>
                                </h2>
                                <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Yes, we provide interactive prototypes before development. </div>
                                </div>
                            </div>
                        </div>
